...
#
#
# This is derived from SalmonTool package
#
# https://github.com/COMBINE-lab/SalmonTools
#
# Properly use bedtool argument here. I have bedtools installed in the
# system hence I did not pass the argument -b with path to binary
...
# Required arguments
if [ -z "$gtffile" -o -z "$outfolder" -o -z "$genomefile" -o -z "$txpfile" -o -z "$mashmap" -o -z "$awk" -o -z "$bedtools" -o -z "$threads" ]; then
